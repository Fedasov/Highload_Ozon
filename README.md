...
![drawSQL-image-export-2024-10-23.png](images/drawSQL-image-export-2024-10-23.png)
...
**Order_Item**
```
  id(16) + profile_id(16) + track_id(16) + creating(8) + product_id(16) + cost(17) + status(1)= 90
```
