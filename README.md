...
### Изменения:
* Shopping_Cart: 
  * Добавлены: price, title, quantity, product_img
* Product: 
  * Добавлены: seller_name
* Comment:
    * Добавлены: user_name, user_surname, photo_profile
* Seller_Product:
    * Добавлены: title, price, product_img, rating_number, rating_sum, number_comment
* Order_Item:
    * Добавлены: product_img, date_start, date_finish, full_amount_order
* Profile:
    * Добавлены: rating_number, rating_sum
...
--------| -----------
Session | Redis      
Profile, Session, Seller_Product, Rating_Seller, Comment, Product, Shopping_Cart, Order_Item, Tracking, List_Pick-up | PostgreSQL 
...
-----------------------|-------------------------------------------| -----------------
Profile                | profile_id <br/> phone_number <br/> email | ускорить поиск пользователей по profile_id <br/> ускорить поиск пользователей по номеру телефона <br/> ускорить поиск пользователей по номеру адресу электронной почты
...
Rating_Seller          | profile_recipient                         | для быстрого получения рейтинга продавца
...
##### Описание:
Упорядочивание извлеченных товаров по релевантности запросу пользователя.
...
* Проверка наличия товаров в результате поиска перед выводом пользователю.
